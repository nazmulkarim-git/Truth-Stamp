...
// Use a cubic-bezier easing array to satisfy Framer Motion's Easing type
      ...
      <header className="sticky top-0 z-40 border-b border-slate-200/70 bg-white/85 backdrop-blur">
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-3">
          ...
          <nav className="hidden items-center gap-6 md:flex">
            ...
            <a href="#workspace" className="text-sm text-slate-600 hover:text-slate-900">
              Workspace
            </a>
            <a href="#trust" className="text-sm text-slate-600 hover:text-slate-900">
              Trust
            </a>
          </nav>
          ...
          >
            <motion.div variants={fadeUp}>
              ...
              <div className="mt-6 flex flex-wrap items-center gap-2 text-xs text-slate-500">
                <Badge variant="secondary" className="border border-slate-200 bg-white/80 text-slate-700">
                  C2PA-aware
                </Badge>
                <Badge variant="secondary" className="border border-slate-200 bg-white/80 text-slate-700">
                  EXIF + FFprobe
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm text-blue-800/90">
                          Structured analysis + reproducible metadata extraction. When possible,
            ...
            <motion.div variants={fadeUp} className="flex items-end justify-between gap-6">
              <div>
                ...
                <p className="mt-3 max-w-2xl text-slate-600">
                  TruthStamp extracts signals, explains them, and produces outputs you can reference.
                </p>
              </div>
            </motion.div>
        ...
        <div className="mx-auto w-full max-w-6xl px-4 py-14 md:py-16">
          <div className="flex items-end justify-between gap-6">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-slate-600">
                You are producing defensible artifacts for real decisions.
              </p>
            </div>
          </div>
              ...
              <Card key={u.title} className="border-slate-200/70 bg-white shadow-sm">
                <CardContent className="p-6">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="grid h-10 w-10 place-items-center rounded-2xl bg-blue-600/10 text-blue-700">
