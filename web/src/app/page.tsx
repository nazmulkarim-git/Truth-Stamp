...
export default function HomePage() {
  ...
  const useCases = useMemo(
    () => [
      {
        title: "Legal & Court",
        desc: "Prepare evidence packets with audit trails and reproducible extraction.",
      },
      {
        title: "Journalism",
        desc: "Prove what is known, what is uncertain, and what metadata supports it.",
      },
      {
        title: "Insurance",
        desc: "Reduce AI-driven fraud and speed up claim decisions.",
      },
      {
        title: "Compliance",
        desc: "Maintain consistent verification and retention policies.",
      },
    ],
    []
  );
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <section className="relative overflow-hidden">
        ...
        <AnimatedBlob
          className="left-[-120px] top-[-90px] h-[320px] w-[320px] bg-blue-500/35"
          delay={0}
        />
        <AnimatedBlob
          className="right-[-140px] top-[60px] h-[360px] w-[360px] bg-sky-400/30"
          delay={0.6}
        />
        <AnimatedBlob
          className="left-[30%] bottom-[-180px] h-[420px] w-[420px] bg-blue-600/20"
          delay={1.1}
        />
          ...
          >
            <motion.div variants={fadeUp}>
              ...
              <h1 className="mt-5 text-4xl font-semibold tracking-tight text-slate-900 md:text-5xl">
                Trust media with <span className="text-blue-600">evidence</span>,
                not guesses.
              </h1>

              <p className="mt-4 max-w-xl text-base leading-relaxed text-slate-600 md:text-lg">
                TruthStamp extracts authenticity signals from images and videos and
                turns them into decision-ready findings. For anyone who needs to
              ...
              <div className="mt-6 flex flex-wrap items-center gap-2 text-xs text-slate-500">
                <Badge
                  variant="secondary"
                  className="bg-white/80 border border-slate-200 text-slate-700"
                >
                  C2PA-aware
                </Badge>
                <Badge
            ...
            <motion.div variants={fadeUp} className="relative">
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between gap-3">
                    <div>
                      ...
                      <div className="text-xs text-slate-500">
                        A preview of what your scan produces
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm text-blue-800/90">
                          A structured analysis + reproducible metadata extraction.
                          When possible, cryptographic provenance is highlighted
                          separately from weaker signals.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 flex items-center justify-between text-xs text-slate-500">
                    ...
                    <span className="inline-flex items-center gap-1">
                      <Lock className="h-3.5 w-3.5 text-blue-600" /> PDF export
                      requires login
                    </span>
                  </div>
                </CardContent>
              ...
              >
                ...
                <p className="mt-2 text-xs text-slate-600">
                  Show users what is proven vs inferred—so they can act.
                </p>
              </motion.div>
            ...
            >
              <div>
                ...
                <p className="mt-3 max-w-2xl text-slate-600">
                  TruthStamp is designed for high-stakes workflows: it extracts
                  signals, explains them, and produces outputs you can reference.
                </p>
              </div>
            </motion.div>
          ...
          <div className="grid gap-8 md:grid-cols-2 md:items-center">
            <div>
              ...
              <p className="mt-3 text-slate-600">
                Not logged in? Upload a single file and see results. Need PDF +
                cases? Create an account.
              </p>
            ...
            <Card className="border-slate-200/70 bg-white shadow-sm">
              <CardContent className="p-6">
                ...
                <div className="mt-5 text-xs text-slate-500">
                  Tip: keep files under your configured upload limit on Render free
                  plan.
                </div>
              </CardContent>
            </Card>
        ...
        <div className="mx-auto w-full max-w-6xl px-4 py-14 md:py-16">
          <div className="flex items-end justify-between gap-6">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-slate-600">
                You are not detecting deepfakes. You are producing defensible
                artifacts for real decisions.
              </p>
            </div>
          </div>
        ...
        <div className="mx-auto w-full max-w-6xl px-4 py-14 md:py-16">
          <div className="grid gap-8 md:grid-cols-2 md:items-center">
            <div>
              ...
              <p className="mt-3 text-slate-600">
                Login unlocks case dashboards, file history, and report exports—so
                TruthStamp becomes the place you manage evidence.
              </p>
          ...
          <div className="rounded-3xl border border-slate-200 bg-gradient-to-br from-blue-50 via-white to-white p-8 shadow-sm md:p-10">
            <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-3 max-w-2xl text-slate-600">
                  TruthStamp is built to separate what is provable from what is
                  inferred, and present it with clarity. That is what makes it
                  useful.
                </p>
              </div>
              ...
              {[
                {
                  ...
                  title: "Proof-forward",
                  desc: "Cryptographic provenance surfaced first.",
                },
                {
                  icon: <ScanSearch className="h-5 w-5" />,
                  title: "Explainable",
                  desc: "Clear findings and confidence framing.",
                },
                {
                  icon: <Lock className="h-5 w-5" />,
                  title: "Defensible",
                  desc: "Hashes + workflow trail for audits.",
                },
              ].map((x) => (
                <div
                  key={x.title}
        ...
        <div className="mx-auto w-full max-w-6xl px-4 py-10">
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-wrap gap-3 text-sm">
              ...
              <Link className="text-slate-600 hover:text-slate-900" href="/cases">
                Cases
              </Link>
            </div>
          </div>
